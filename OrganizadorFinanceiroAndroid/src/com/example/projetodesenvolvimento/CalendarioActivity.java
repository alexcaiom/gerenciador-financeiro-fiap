...
public class CalendarioActivity extends Activity implements OnClickListener
{
	...
	public void onCreate( Bundle savedInstanceState )
	{
		...
		// Initialised
		adapter = new GridCellAdapter( getApplicationContext( ), R.id.calendar_day_gridcell, month,
				year ) ;
	...
	public void onClick( View v )
	{
		if (v == prevMonth)
		{
			...
			Log.d( tag, "Setting Prev Month in GridCellAdapter: " + "Month: " + month + " Year: "
					+ year ) ;
		...
		if (v == nextMonth)
		{
			...
			Log.d( tag, "Setting Next Month in GridCellAdapter: " + "Month: " + month + " Year: "
					+ year ) ;
			setGridCellAdapterToDate( month, year ) ;
		}
	...
	public class GridCellAdapter extends BaseAdapter implements OnClickListener
	{
		...
		private void printMonth( int mm, int yy )
		{
			...
			if (currentMonth == 11)
			{
				...
				prevYear = yy ;
				nextYear = yy + 1 ;
				Log.d( tag, "*->PrevYear: " + prevYear + " PrevMonth:" + prevMonth + " NextMonth: "
						+ nextMonth + " NextYear: " + nextYear ) ;
			}
