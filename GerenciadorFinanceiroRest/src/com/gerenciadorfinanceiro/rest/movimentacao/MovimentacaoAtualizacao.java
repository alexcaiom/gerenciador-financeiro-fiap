...
@Path(ConstantesMapeamentoRest.MOVIMENTACAO_ATUALIZACAO)
public class MovimentacaoAtualizacao extends Classe{
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Object incluir(@PathParam("login") String login, 
						  @PathParam("codigo") String codigo, @PathParam("valor") String valor, 
